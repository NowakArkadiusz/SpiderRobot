...
TIM4->CCR3=2800;*/
	...
	if (z2F1<=200)
	{
		TIM2->CCR3=2800+z2F1*2.5; //+500
		TIM4->CCR1=2650-z2F1*2.5; //-500
		z2F1++;
		delay_ms(1);
	...
	{
		TIM2->CCR3=3300-z4F1*2.5;
		TIM4->CCR1=2150+z4F1*2.5;
		z4F1++;
		status=1;
	}
	if (z4F1 >200)
...
void MoveForward2(void)
{
	...
	if (z2F2<=200)
	{
		TIM4->CCR4=2800-z2F2*2.5; //-500
		TIM3->CCR2=3100+z2F2*2.5; //+500
		z2F2++;
		delay_ms(1);
	...
	{
		TIM4->CCR4=2300+z4F2*2.5;
		TIM3->CCR2=3600-z4F2*2.5;
		z4F2++;
	}
...
void MoveBackwards1(void)
{
	...
	if (z2F1<=500)
	{
		TIM2->CCR3=3100-z2F1; //-500
		TIM4->CCR1=2250+z2F1; //+500
		z2F1++;
		delay_ms(1);
...
void MoveBackwards2(void)
{
	...
	if (z2F2<=500)
	{
		TIM4->CCR4=2500+z2F2; //+500
		TIM3->CCR2=3400-z2F2; //-500
		z2F2++;
		delay_ms(1);
...
void TurnLeft1(void)
{
	...
	if (z2F1<=200)
	{
		TIM3->CCR2=3100-z2F1*2; //-400
		TIM4->CCR4=2800-z2F1*2; //-400
		z2F1++;
		delay_ms(1);
	...
	if(z2F1>200 && z4F1<=200)
	{
		TIM3->CCR2=2700+z4F1*2;
		TIM4->CCR4=2400+z4F1*2;
		z4F1++;
		status=2;
	}
	if (z4F1 >200)
...
void TurnLeft2(void)
{
	...
	if (z2F2<=200)
	{
		TIM4->CCR1=2650-z2F2*2; //-400
		TIM2->CCR3=2800-z2F2*2; //-400
		z2F2++;
		delay_ms(1);
	...
	if (z2F2>200 && z4F2<=200)
	{
		TIM4->CCR1=2250+z4F2*2;
		TIM2->CCR3=2400+z4F2*2;
		z4F2++;
	}
	if (z4F2 >200)
	{
...
void TurnRight1(void)
{
	...
	if (z2F2>200 && z4F2<=200)
	{
		TIM4->CCR1=3050-z4F2*2;
		TIM2->CCR3=3200-z4F2*2;
		z4F2++;
		status=3;
...
void TurnRight2(void)
{
	...
	if(z2F1>200 && z4F1<=200)
	{
		TIM3->CCR2=3500-z4F1*2;
		TIM4->CCR4=3200-z4F1*2;
		z4F1++;
	}
	if (z4F1 >200)
	{
...
void abc (void)
{
		if (z1F1<100)
	{
		...
		if (z2F1<=200)
	{
		TIM4->CCR4=2800-z2F1*2.5; //+500
		TIM2->CCR3=3283-z2F1/1.2;
		TIM3->CCR2=3291-z2F1/1.2;
		TIM4->CCR1=2650+z2F1/1.2;
		z2F1++;
		delay_ms(1);
...
void abc2(void)
{
	...
	if (z2F2<=200)
	{
		TIM3->CCR2=3125+z2F2*2.5; //-600
		TIM2->CCR3=3116-z2F2/1.2;
		TIM4->CCR4=2300+z2F2/1.2;
		TIM4->CCR1=2817+z2F2/1.2;
		z2F2++;
		delay_ms(1);
...
void abc3 (void)
{
   //Noga3
	...
	if (z2F3<=200)
	{
		TIM2->CCR3=2950+z2F3*2.5; //+500
		TIM3->CCR2=3625-z2F3/1.2;
		TIM4->CCR4=2467+z2F3/1.2;
		TIM4->CCR1=2984+z2F3/1.2;
		z2F3++;
		delay_ms(1);
...
{	 
	...
	if (z2F4<=200)
	{
		TIM4->CCR1=3150-z2F4*2.5; //-500
		TIM3->CCR2=3458-z2F4/1.2;
		TIM4->CCR4=2634+z2F4/1.2;
		TIM2->CCR3=3450-z2F4/1.2;
		z2F4++;
		delay_ms(1);
